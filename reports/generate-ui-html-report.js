...
const reportPath = path.join(__dirname, 'cucumber-ui-report.json');
const outPath = path.join(__dirname, 'ui-test-report.html');
...
const title = 'UI Cucumber Test Report';
...
console.log('UI HTML report written to', outPath);
